...
pca1 <- preProcess(trainsc1[, -ncol(trainsc1)], method = 'pca', ncomp=12)
trainpca1 <- predict(pca1, trainsc1[,-ncol(trainsc1)])
trainpca1 <- cbind(trainpca1, trainsc1[,ncol(trainsc1)])

testpca1 <- predict(pca1, testsc1[,-ncol(testsc1)])
...
pca2 <- preProcess(trainsc2[, -ncol(trainsc2)], method = 'pca', ncomp=14)
trainpca2 <- predict(pca2, trainsc2[,-ncol(trainsc2)])
trainpca2 <- cbind(trainpca2, trainsc2[,ncol(trainsc2)])

testpca2 <- predict(pca2, testsc2[,-ncol(testsc2)])
